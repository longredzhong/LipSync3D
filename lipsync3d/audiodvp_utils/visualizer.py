...
class Visualizer:
    ...
    def plot_current_texture(self, total_iters, predicted_mouths, gt_mouths):
        self.writer.add_image('Training/Predicted Texture', torchvision.utils.make_grid(predicted_mouths), total_iters)
        self.writer.add_image('Training/Ground Truth Texture', torchvision.utils.make_grid(gt_mouths), total_iters)
